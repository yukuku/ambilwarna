...
public class AmbilWarnaXPreference extends androidx.preference.Preference {
	private final boolean supportsAlpha;
	int value;

	public AmbilWarnaXPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private static class SavedState extends BaseSavedState {
		...
		@SuppressWarnings("unused") public static final Creator<SavedState> CREATOR = new Creator<AmbilWarnaXPreference.SavedState>() {
			public AmbilWarnaXPreference.SavedState createFromParcel(Parcel in) {
				return new AmbilWarnaXPreference.SavedState(in);
			}

			public AmbilWarnaXPreference.SavedState[] newArray(int size) {
				return new AmbilWarnaXPreference.SavedState[size];
			}
		};
	}
}
